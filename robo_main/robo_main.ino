 ...
 * all automatic functions must have the return type void and a single char* as their parameter
 * when called they will be given the address of the data packet that called them in the char*,
